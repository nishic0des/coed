											...
											<div
												...
												className={`relative flex p-6 border rounded-lg cursor-pointer transition-all duration-300 hover:scale-[1.02]
                                                    ${
																											selectedTemplate ===
																											template.id
																												? "border-[#f02828] shadow-[0_0_0_1px_#f02828,0_8px_20px_rgba(233,63,63,0.15)]"
																												: "hover:border-[#f02828] shadow-[0_2px_8px_rgba(0,0,0,0.05)] hover:shadow-[0_8px_20px_rgba(0,0,0,0.1)]"
																										}
                                                    `}
														...
														<div className="flex items-center gap-2 mb-1">
															...
															<div className="flex gap-1">
																{template.category === "frontend" && (
																	<Code size={14} className="text-[#f02828]" />
																)}
																{template.category === "backend" && (
																	<Server
																		size={14}
																		className="text-[#f02828]"
																	/>
																)}
																{template.category === "fullstack" && (
																	<Globe size={14} className="text-[#f02828]" />
																)}
															</div>
														</div>
