	...
	return (
		<div className="z-20 flex flex-col items-center justify-start min-h-screen py-2 mt-5">
			<div className="flex flex-col justify-center items-center my-2">
				...
				<h1 className=" z-20 text-6xl mt-5 font-extrabold text-center bg-clip-text text-transparent bg-gradient-to-r from-rose-400 via-red-500 to-pink-500 dark:from-rose-400 dark:via-red-400 dark:to-pink-400 tracking-tight leading-[1.3] ">
					Next-Gen AI-Powered Code Editor
				</h1>
			</div>

			<p className="mt-2 text-lg text-center text-gray-600 dark:text-gray-400 px-5 py-10 max-w-2xl">
				Coed Editor is a powerful and intelligent code editor that enhances your
