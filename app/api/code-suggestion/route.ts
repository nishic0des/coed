...
function analyzeCodeContext(
	...
	const isAfterComment = detectIsAfterComment(currentLine, line);
	const incompletePatterns = detectIncompletePatterns(currentLine, line);
...
function buildPrompt(context: CodeContext, suggestionType: string): string {
    ...
    - Incomplete Pattern: ${context.incompletePatterns.join(", ") || "None"}
...
function detectIsAfterComment(line: string, column: number): boolean {
